...
const NavItems = ({ isOpen }: NavListProps) => {
  return (
    <>
      ...
      {/* MOBILE NAV ITEMS */}
      <ul
        className={`absolute left-0 top-20 flex w-full transform flex-col items-center gap-6 bg-df-yellow text-lg font-semibold transition-transform dark:bg-zinc-800 xl:hidden ${isOpen ? 'opacity-100' : 'opacity-0'}`}
